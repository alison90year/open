...
const routes = [
    ...
    },
    {
        ...
        redirect: "/about/about-user",
        children: [
            {
                path: 'about-user',
                name: 'about-user',
                component: function () {
                    return import('../views/about-user.vue')
                },
                meta: {
                    myCenterIndex: 0,
                    title:"用户相关"
...

            {
                ...
                name: 'about-Anchor',
                component: function () {
                    return import('../views/about-Anchor.vue')
                },
                meta: {
                    myCenterIndex: 14,
                    title:'主播帮助'
...

            {
                ...
                name: 'about-contact',
                component: function () {
                    return import('../views/about-contact.vue')
                },
                meta: {
                    myCenterIndex: 15,
                    title:'联系我们'
            ...
            //     name: 'about-Feedback',
            //     component: function () {
            //         return import('../views/about-Feedback.vue')
            //     },
            //     meta: {
            //         myCenterIndex: 6,
            //         title: '意见反馈'
