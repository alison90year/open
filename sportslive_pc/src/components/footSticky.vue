<template>
  <div class="match-box" v-if="football.length > 0 " style="margin-top: 1px;">
    <div class="match-data">
      ...
      <table id="list" class="table table-striped" cellspacing="0" cellpadding="0"  ><tbody><tr>
      <tr class="dd-item data dd-3511228"  v-for="(foot, i) in football" :key="i" v-if="foot.is_retain"  :style="i%2==0?('background-color: #f9f9f9'):('background-color: white')"  :class="{  isfontcolor_block:(foot.id == newValue) }">
        ...
        <td class="lab-score color-red">
          <div class="find">
            <el-tooltip class="item" effect="light" placement="right-end"   v-if="state!=8" popper-class="atooltip">
              <div slot="content"  v-if="state!=8">
                ...
                <div style="color:#333;text-align: center;background:#FFf">
                  <div style="background: rgb(57, 187, 243) none repeat scroll 0% 0%;height: 40px;width:107%;padding:15px 5px; position: relative; left:-10px;top:-10px;color:#fff;font-weight: 600; ">
                    ...
                    <span   v-if="state!=8" style="width:23px;">{{foot.main_fraction}}</span>-<span   v-if="state!=8" style="width:23px;">{{foot.deputy_fraction}}</span>
                    <span style="margin-left: 8px;padding-left: 5px;width: 120px;text-align: right">{{ foot.deputy_name }}</span>
                  </div>
                  <br>
                  <div class="scroll"  v-if="foot.statistics.incidents" style="overflow-y: auto;scrollbar-width: none;-ms-overflow-style: none;height: 300px;">
                    <table  class="tab" style="width: 286px;" >
                      <tr v-for="item in foot.statistics.incidents">
                        <td style="width: 110px;text-align: right">
                          <div v-if="item.position==1">
                            ...
                            <div  v-else-if="item.type==11" style="width: 100%;height:25px;color:gray">中场<img width="20px" src="../assets/img/shaozi.png"></div>
                  ...
                  <table v-if="foot.statistics.stats" class="tab">
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[0]" style="width: 40px">{{foot.statistics.stats[0].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[1]" style="width: 40px">{{foot.statistics.stats[1].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[2]" style="width: 40px">{{foot.statistics.stats[2].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[3]" style="width: 40px">{{foot.statistics.stats[3].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[4]" style="width: 40px">{{foot.statistics.stats[4].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[5]" style="width: 40px">{{foot.statistics.stats[5].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[6]" style="width: 40px">{{foot.statistics.stats[6].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[7]" style="width: 40px">{{foot.statistics.stats[7].text}}</td>
                    ...
                    <tr>
                      ...
                      <td v-if="foot.statistics.stats[8]" style="width: 40px">{{foot.statistics.stats[8].text}}</td>
              ...
              <!--主队进球数--> <!--客队进球数-->
              <div class="score"   v-if="state!=8" @click="footballevent(foot)" @mouseenter="jxtjdata(foot.id,state)"><b class="color-red skin-color-s" style="color: #FF7503; font-size: 15px; font-family: 'Microsoft Yahei', 'PingFang SC', 'Avenir', 'Segoe UI', 'Hiragino Sans GB', STHeiti, 'Microsoft Sans Serif', 'WenQuanYi Micro Hei', sans-serif;"><span   v-if="state!=8">{{foot.main_fraction}}</span>-<span   v-if="state!=8">{{foot.deputy_fraction}}</span></b></div>
            </el-tooltip>
            <!--当不是正在进行的比赛时---显示--VS--->
            <div class="score"   v-if="state==8" ><b class="color-red skin-color-s" style="color: #666; font-size: 14px; font-family: 'Microsoft Yahei', 'PingFang SC', 'Avenir', 'Segoe UI', 'Hiragino Sans GB', STHeiti, 'Microsoft Sans Serif', 'WenQuanYi Micro Hei', sans-serif;">VS</b></div>
          </div>
        </td>
        ...
        <!--角球球-->
        <td class="lab-corner" style="text-align: left;color:#333;"><span   v-if="state!=8">{{foot.main_kick}}</span> - <span   v-if="state!=8">{{foot.deputy_kick}}</span></td>
        <!--直播-->
        <td class="lab-live" @click="footballevent(foot)">
          <div style=" width:26px;height:26px;border-radius: 6px;overflow:hidden;cursor:pointer;">
            <img  src="@/assets/img/icon-202.png"  v-if="foot.is_animation == 1 " style="width: 20px" />
        ...
        <td class="lab-sb bd-left"  >
          <el-tooltip class="item"    placement="top" effect="light" style="padding: 0px;">
            <div slot="content">
            ...
            <div class="find">
              <table cellpadding="0" cellspacing="0" >
                ...
                <tr class="color-999 asian">
                  <td class="lab-ratel " style="text-align: right">
                                      <span class="exponent-tow">
                                            <span class="text" style="color:#999" v-if="reversedMessageasia(foot.finger.asia)"  @mouseenter="loadoddsone(foot.id)">
                                            ...
                                            <span v-if="foot.finger.asia != undefined">
                ...
                <tr class="color-666 size">
                  ...
                  <td class="lab-ratel " style="text-align: right">
                                      <span class="exponent-tow">
                                          <span class="text" style="color:#666" v-if="reversedMessageasia(foot.finger.bs)"  @mouseenter="loadoddsone(foot.id)">
                                            ...
                                            <span v-if="foot.finger.bs != undefined">
                  ...
                  <td class="lab-bet-odds " style="text-align: right">
                                        <span class="exponent-tow">
                                            <span class="text" style="color:#666" v-if="reversedMessageasia(foot.finger.bs)"  @mouseenter="loadoddsone(foot.id)">
                                                <span  v-if="reversedMessageD1(foot.finger.bs.D1)"> <!--foot.finger.asia.D1 !=undifend-->
                                                    <span v-if="reversedMessage(foot.finger.bs.D1)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                        <span v-if="reversedMessageA1(foot.finger.bs.B1)" class="A1"><!--foot.finger.asia.A1!=undifend-->
        ...
        <td class="lab-data" style="padding-right: 10px;text-align: right;">
          <div class="sticky" @click="CancelfootSticky(foot,i)" style="cursor:pointer;">
            <!--<i class = "el-icon-upload2"></i>-->
            <img width="14px" :src="zhidingzhiding" >
          </div>
        </td>
        <!--收藏-->
        <td class="lab-popularity">
          <div class="follow" @click="userFollow(foot,i)" v-if="type != 3" style="cursor:pointer;">
            ...
            <img width="14px" class="hongxinghover" :src="ishover==i?shoucanghover:shoucang" @mouseleave="ishover=-1" @mouseover="ishover=i">
          </div>
        </td>
        <td class="lab-func">
  ...
  <notHave v-else-if='(type != 0 && football.length == 0 && type != 4  && type != 1 && type != 3 && type != 5) || (type != 0 && state == 0)||(type != 0 && type != 1 &&type != 3) '>
  </notHave>
</template>
...
export default {
  props: ["football","type","state","iszhujin","iskejin","whichcom","isfont","shujuTDname",'isclosed' ,"typees" ,"searchnub",'companys','chuangjianasiaa1'],
  name: "foot",
  components: {
    notHave
  },
  data() {
    return {
      ...
      zhidingzhiding:require("../assets/zhidingzhiding.png"),
  ...
  methods:{
    CancelfootSticky(foot,index){
      let data = {
        "foot":foot,
        'type':this.type,
        'index':index
      }
      this.$emit('CancelfootSticky',data)
    },
  ...
  watch: {
    searchnub:{
      handler: function (newVal, oldVal) {
        ...
        // console.log(this.searchnubFoot + "foot.vue/446")
      },
    },
    chuangjianasiaa1:{
      handler: function (newVal, oldVal) {
        if(newVal !== undefined){
          this.chuangjianasiaa11 = newVal
        }
        console.log(newVal)
        // console.log(this.searchnubFoot + "foot.vue/446")
      },
