      ...
      <table id="list" class="table table-striped" cellspacing="0" cellpadding="0"  style="display: flex;" >
        ...
        <tr class="dd-item data dd-3511228" v-for="(foot, i) in football" :key="i"   :style="i%2==0?('background-color: #f6f8fd'):('background-color: white')"  :class="{  isfontcolor_block:(foot.id == newValue) }">
          ...
          <td class="lab-events"  :class="foot.short_name_zh" :style="{background:foot.events_color}" :id="'saishi'+ foot.short_name_zh">
            ...
            <a class="event-name lang" href="javascript:void(0)" target="_self" style="text-align:center;width: 100%;position: relative;color:#FFFFFF">&nbsp;&nbsp;&nbsp;{{ foot.short_name_zh }}</a>
          </td>
          <!--时间-->
          <td class="lab-time" style="color: #434A66">
          ...
          <td class="lab-team-home bd-left" :class="foot.main_name" :style="iszhujin==foot.id?('background:#ffd6d3;width: 160px;'):('width: 160px;font-weight: 600;color: #333;')" :id="'zhuduiming' + foot.main_name">
            ...
            <!--主队--进球--->
            <span class="name color-666 lang " style="color: #434A66" :style="iszhujin==foot.id?('background:#ffd6d3;color:#de1e30;'):('color: #333;')">
              ...
              <el-tooltip class="item" effect="light" placement="right-end"   v-if="foot.status != 1" popper-class="atooltip">
                <div slot="content"  v-if="foot.status!=1">
                  ...
                  <div style="color:#333;text-align: center;background:#FFf">
                    <div style="background:linear-gradient(to right, #ECCBAB,#DBB16F);height: 40px;width:107%;padding:15px 5px; position: relative; left:-10px;top:-10px;color:#fff;font-weight: 600; ">
                        ...
                        <tr   v-for="item in foot.statistics.incidents">
                          <td style="width: 110px;text-align: right">
                            ...
                            <div v-if="item.position==1">
                              ...
                              <!--                                     <div  v-else-if="item.type==19" style="width: 50px;height:25px;color:#434A66"><img width="24px" src="../assets/img/shaozi.png">伤停补时 </div>-->
                    ...
                    <div  v-if="foot.statistics">
                      <table v-if="foot.statistics.stats" class="tab">
                        ...
                        <tr>
                          ...
                          <td v-if="foot.statistics.stats[0]" style="width: 110px"><el-progress v-if="foot.statistics"  class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[0].home,foot.statistics.stats[0].away)" :show-text="false" color="#47CC6C" ></el-progress></td>
                          <td v-if="foot.statistics.stats[0]" style="width: 40px">角球</td>
                          <td v-if="foot.statistics.stats[0]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[0].home,foot.statistics.stats[0].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[0]">{{foot.statistics.stats[0].away}}</td>

                          <td v-if="!foot.statistics.stats[0]">0</td>
                          <td v-if="!foot.statistics.stats[0]" style="width: 110px"><el-progress v-if="foot.statistics"  class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[0]" style="width: 40px">角球</td>
                          <td v-if="!foot.statistics.stats[0]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[0]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[1]">{{foot.statistics.stats[1].home}}</td>
                          <td v-if="foot.statistics.stats[1]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[1].home,foot.statistics.stats[1].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[1]" style="width: 40px">黄牌</td>
                          <td v-if="foot.statistics.stats[1]" style="width: 110px"><el-progress v-if="foot.statistics.stats[1]" :percentage="jindutiao2(foot.statistics.stats[1].home,foot.statistics.stats[1].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[1]">{{foot.statistics.stats[1].away}}</td>

                          <td v-if="!foot.statistics.stats[1]">0</td>
                          <td v-if="!foot.statistics.stats[1]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[1]" style="width: 40px">黄牌</td>                  
                          <td v-if="!foot.statistics.stats[1]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[1]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[2]">{{foot.statistics.stats[2].home}}</td>
                          <td v-if="foot.statistics.stats[2]" style="width: 110px"><el-progress  class="mirrorRotateLevel" v-if="foot.statistics" :percentage="jindutiao(foot.statistics.stats[2].home,foot.statistics.stats[2].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[2]" style="width: 40px">红牌</td>
                          <td v-if="foot.statistics.stats[2]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[2].home,foot.statistics.stats[2].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[2]">{{foot.statistics.stats[2].away}}</td>

                          <td v-if="!foot.statistics.stats[2]">0</td>
                          <td v-if="!foot.statistics.stats[2]" style="width: 110px"><el-progress  class="mirrorRotateLevel" v-if="foot.statistics" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[2]" style="width: 40px">红牌</td>
                          <td v-if="!foot.statistics.stats[2]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[2]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[3]">{{foot.statistics.stats[3].home}}</td>
                          <td v-if="foot.statistics.stats[3]" style="width: 110px"><el-progress  class="mirrorRotateLevel" v-if="foot.statistics" :percentage="jindutiao(foot.statistics.stats[3].home,foot.statistics.stats[3].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[3]" style="width: 40px">点球</td>
                          <td v-if="foot.statistics.stats[3]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[3].home,foot.statistics.stats[3].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[3]">{{foot.statistics.stats[3].away}}</td>

                          <td v-if="!foot.statistics.stats[3]">0</td>
                          <td v-if="!foot.statistics.stats[3]" style="width: 110px"><el-progress  class="mirrorRotateLevel" v-if="foot.statistics" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[3]" style="width: 40px">点球</td>
                          <td v-if="!foot.statistics.stats[3]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[3]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[4]">{{foot.statistics.stats[4].home}}</td>
                          <td v-if="foot.statistics.stats[4]" style="width: 110px"><el-progress  v-if="foot.statistics" class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[4].home,foot.statistics.stats[4].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[4]" style="width: 40px">射正</td>
                          <td v-if="foot.statistics.stats[4]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[4].home,foot.statistics.stats[4].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[4]">{{foot.statistics.stats[4].away}}</td>

                          <td v-if="!foot.statistics.stats[4]">0</td>
                          <td v-if="!foot.statistics.stats[4]" style="width: 110px"><el-progress  v-if="foot.statistics" class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[4]" style="width: 40px">射正</td>
                          <td v-if="!foot.statistics.stats[4]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[4]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[5]">{{foot.statistics.stats[5].home}}</td>
                          <td v-if="foot.statistics.stats[5]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[5].home,foot.statistics.stats[5].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[5]" style="width: 40px">射偏</td>
                          <td v-if="foot.statistics.stats[5]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[5].home,foot.statistics.stats[5].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[5]">{{foot.statistics.stats[5].away}}</td>

                          <td v-if="!foot.statistics.stats[5]">0</td>
                          <td v-if="!foot.statistics.stats[5]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[5]" style="width: 40px">射偏</td>
                          <td v-if="!foot.statistics.stats[5]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[5]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[6]">{{foot.statistics.stats[6].home}}</td>
                          <td v-if="foot.statistics.stats[6]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[6].home,foot.statistics.stats[6].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[6]" style="width: 40px">进攻</td>
                          <td v-if="foot.statistics.stats[6]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[6].home,foot.statistics.stats[6].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[6]">{{foot.statistics.stats[6].away}}</td>

                          <td v-if="!foot.statistics.stats[6]">0</td>
                          <td v-if="!foot.statistics.stats[6]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[6]" style="width: 40px">进攻</td>
                          <td v-if="!foot.statistics.stats[6]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[6]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[7]">{{foot.statistics.stats[7].home}}</td>
                          <td v-if="foot.statistics.stats[7]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[7].home,foot.statistics.stats[7].away)" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[7]" style="width: 40px">危险进攻</td>
                          <td v-if="foot.statistics.stats[7]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[7].home,foot.statistics.stats[7].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[7]">{{foot.statistics.stats[7].away}}</td>

                          <td v-if="!foot.statistics.stats[7]">0</td>
                          <td v-if="!foot.statistics.stats[7]" style="width: 110px"><el-progress v-if="foot.statistics" class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[7]" style="width: 40px">危险进攻</td>
                          <td v-if="!foot.statistics.stats[7]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[7]">0</td>
                        </tr>
                        <tr>
                          <td v-if="foot.statistics.stats[8]">{{foot.statistics.stats[8].home}}</td>
                          <td v-if="foot.statistics.stats[8]" style="width: 110px"><el-progress v-if="foot.statistics"  class="mirrorRotateLevel" :percentage="jindutiao(foot.statistics.stats[8].home,foot.statistics.stats[8].away) " color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[8]" style="width: 40px">控球率</td>
                          <td v-if="foot.statistics.stats[8]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="jindutiao2(foot.statistics.stats[8].home,foot.statistics.stats[8].away)" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="foot.statistics.stats[8]">{{foot.statistics.stats[8].away}}</td>

                          <td v-if="!foot.statistics.stats[8]">0</td>
                          <td v-if="!foot.statistics.stats[8]" style="width: 110px"><el-progress v-if="foot.statistics"  class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[8]" style="width: 40px">控球率</td>
                          <td v-if="!foot.statistics.stats[8]" style="width: 110px"><el-progress v-if="foot.statistics" :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td v-if="!foot.statistics.stats[8]">0</td>
                        </tr>
                      </table>
                      <table v-if="!foot.statistics.stats" class="tab">
                        ...
                        <tr>
                          <td >0</td>
                          <td  style="width: 110px"><el-progress   class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
                          <td  style="width: 40px">角球</td>
                          <td  style="width: 110px"><el-progress  :percentage="0" color="#7670B6" :show-text="false"></el-progress></td>
                          <td >0</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td >0</td>
                          <td  style="width: 110px"><el-progress v-if="foot.statistics"  class="mirrorRotateLevel" :percentage="0" color="#47CC6C" :show-text="false"></el-progress></td>
          ...
          <td class="lab-team-away" style="color: #434A66" :style="iskejin==foot.id?('background:#ffd6d3;width: 160px;'):('width: 160px;font-weight: 600;')" :id="'keduiming' + foot.deputy_name">
            <!--客队名--->
          ...
          <!--半场进球-->
          <td class="lab-half" style="text-align: left;color: #434A66"><span  v-if="foot.status!=1">{{foot.main_half_fraction}}</span> - <span   v-if="foot.status!=1">{{foot.deputy_half_fraction}}</span></td>
          <!--角球球-->
          <td class="lab-corner" style="text-align: left;color: #434A66"><span   v-if="foot.status!=1">{{foot.main_kick}}</span> - <span   v-if="foot.status!=1">{{foot.deputy_kick}}</span></td>
          <!--直播-->
          ...
          <td class="lab-sb bd-left" style="display:flex;width: 174px;align-items: center;height: 40px;" >
            <el-tooltip class="item"    placement="top" effect="light" style="padding: 0px;" v-if="foot.status != 1 && foot.status != 8 && foot.status != 9 && foot.status != 13">
              <div slot="content">
                <div style="width: 100%;background: rgba(0, 0, 0, 0) linear-gradient(to right, rgb(236, 203, 171), rgb(219, 177, 111)) repeat scroll 0% 0%;height: 30px;line-height: 30px; text-align: center">
                ...
                <table cellpadding="0" cellspacing="0" >
                    ...
                    <td class="lab-ratel " style="text-align: right">
                                          <span class="exponent-tow">
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                       <span v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                           <span v-if="reversedMessageD1es(foot.finger.asia.A1) && reversedMessageA1(foot.finger.asia.A)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                                                ...
                                                <span v-if="foot.finger.asia">
                                                    <span v-if="foot.finger.asia.D1 == undefined && foot.finger.asia.D != undefined" style="padding-right: 10px">
                    ...
                    <td class="lab-bet-odds " style="text-align: right">
                                          <span class="exponent-tow"  >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                         <span v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                             <span v-if="reversedMessageD1es(foot.finger.asia.B1) && reversedMessageA1(foot.finger.asia.B)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                    ...
                    <td class="lab-rater " style="text-align: right">
                                          <span class="exponent-tow" >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"   @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                        <span v-if="reversedMessageD1es(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                                <span v-if="reversedMessageD1es(foot.finger.asia.C1) && reversedMessageA1(foot.finger.asia.C)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                  ...
                  <tr class="color-999 asian"  v-if="foot.finger">
                    <td class="lab-ratel " style="text-align: right">
                                          <span class="exponent-tow">
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                       <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                           <span v-if="reversedMessageA1(foot.finger.asia.A1) && reversedMessageD1es(foot.finger.asia.A)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                    ...
                    <td class="lab-bet-odds " style="text-align: right">
                                          <span class="exponent-tow"  >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                         <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                             <span v-if="reversedMessageA1(foot.finger.asia.B1) && reversedMessageD1es(foot.finger.asia.B)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                    ...
                    <td class="lab-rater " style="text-align: right">
                                          <span class="exponent-tow" >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"   @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                        <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessageD1es(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                                <span v-if="reversedMessageA1(foot.finger.asia.C1) && reversedMessageD1es(foot.finger.asia.C)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                  ...
                  <tr class="color-999 asian"  v-if="foot.finger">
                    <td class="lab-ratel " style="text-align: right">
                                          <span class="exponent-tow">
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                       <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                           <span v-if="reversedMessageA1(foot.finger.asia.A1) && reversedMessageA1(foot.finger.asia.A)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                                                                 {{foot.finger.asia.A1 | numberformat}}
                                                            </span>
                                                        </span>
                                                    </span>
                    ...
                    <td class="lab-bet-odds " style="text-align: right">
                                          <span class="exponent-tow"  >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"  @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                         <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                             <span v-if="reversedMessageA1(foot.finger.asia.B1) && reversedMessageA1(foot.finger.asia.B)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                                                                 {{foot.finger.asia.B1 | numberformat}}
                                                            </span>
                                                        </span>
                                                    </span>
                    ...
                    <td class="lab-rater " style="text-align: right">
                                          <span class="exponent-tow" >
                                                <span class="text" v-if="foot.finger.asia" style="color:#999"   @mouseenter="loadoddsone(foot.id)">
                                                    <span  v-if="reversedMessageD1(foot.finger.asia.D1) && reversedMessageD1(foot.finger.asia.D)"> <!--foot.finger.asia.D1 !=undifend-->
                                                        <span v-if="reversedMessage(foot.finger.asia.D1) && reversedMessage(foot.finger.asia.D)" class="D1"><!--foot.finger.asia.D1 ==0-->
                                                                <span v-if="reversedMessageA1(foot.finger.asia.C1) && reversedMessageA1(foot.finger.asia.C)" class="A1"><!--foot.finger.asia.A1!=undifend-->
                                                                    {{foot.finger.asia.C1 | numberformat}}
                                                                </span>
                                                            </span>
                                                        </span>
          ...
          <!--分析-->
          <td class="lab-data" style="width: 80px;text-align: center;cursor:pointer;color: #434A66">
          ...
          <!--人气-->
          <td class="lab-data" style="width: 60px;text-align: center;cursor:pointer;color: #434A66" @click="newwindower(foot.id)">
            <span style="color:#9197ad"> <i class="el-icon-user"></i></span>
            <span style="color:#9197ad" >{{foot.popularity}}</span>
          </td>
          <!--                阵容-->
          <td class="lab-data" style="width:60px;text-align: center;cursor:pointer;color: #EFA34D;" @click="footballevent(foot)">
            <span  v-if="foot.is_ilineup == 1" >情报</span>
          </td>
          <!--置顶-->
...
export default {
  ...
  data() {
    return {
      ...
      shoucanghover:require("../assets/shoucangzhiding.png"),
      shoucang:require("../assets/shoucang.png"),
      zhidinghover:require("../assets/zhidingzhiding.png"),
  ...
  methods:{
    ...
    reversedMessageD1es:function(val) {
      //    console.log(val != undefined?true:false)
      return  val == undefined?true:false
    },
