<template>
  <div class="liveTypewrapperinner">
    <div class="liveTypenav">
      ...
      <div class="liveTvbottomaa">
        <ul>
          <li>
            <a href="https://longya.daoyunxiang.com/">
              <span><img src="../assets/livexia.png" alt="" srcset="" /></span>
            </a>
          </li>
          <li>
            <router-link :to="{ name: 'about-Anchor' }">
              <span><img src="../assets/zhubo.png" alt="" srcset="" /></span>
            </router-link>
          </li>
          <li class="bangzhu">
