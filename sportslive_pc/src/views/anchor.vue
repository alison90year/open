        ...
        <el-form-item prop="user_card_front">
          ...
          <div>
            <el-upload
                ...
                :disabled="true"
            >
              <img :src="user_card_front" class=" idcard" />
          ...
          <div>
            <el-upload
                ...
                :disabled="true"
            >
              <img :src="user_card_reverse" class=" idcard" />
              <!-- <i class="el-icon-plus avatar-uploader-icon"></i> -->
            </el-upload>
          </div>
        </el-form-item>
...
<script>
import {  UserApplyAnchor,GetUserinfo, live_auth_info,Register} from "@/api";
...
export default {
  ...
  mounted() {
    ...
    this.anchorcode = JSON.parse(window.localStorage.getItem("anchorcode"))
    console.log(this.anchorcode);
  },
    ...
    getlive() {
      ...
      live_auth_info(data).then((res) => {
        this.name= res.info.name,
            ...
            this.user_card_front1  =res.info.user_card_front.substring(24)
        this.user_card_front = this.user_card_front1 ,
            console.log(res.info)
        this.user_card_reverse=res.info.user_card_reverse.substring(24),
            this.params = {
              uid: this.user.uid,
              token: this.token,
              name: res.info.name,
