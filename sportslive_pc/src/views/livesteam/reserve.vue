        ...
        <div class="yycontent">
          <div class="yyicon">
            ...
            <div class="yycenter">
              ...
              <div v-else class="nyybtn" @click="cancelclick(item, index)">
                取消预约
              </div>
            </div>
          </div>
          ...
          <div class="yyright">
            ...
            <public-swiper
                ...
                height="74px"
                width="480px"
                className="yylist_swiper"
                swiperPage="egameTop_swiper"
                v-else
            >
              <template slot-scope="options">
                <div class="game_topList" :key="options.options.uid">
                  <div class="xxx1">
                    <img :src="options.options.icon" class="game_logo" alt="" style="margin-top:10px" />
                    <!-- <p class="p_title">{{ options.options.nick_name }}</p> -->
                  </div>
                </div>
              </template>
  ...
  data() {
    return {
      ...
      imglist: [
        {
          icon:
              "http://107.148.224.65:84/upload/default.png",
          nick_name: "哈哈哈哈",
        },
        {
          icon:
