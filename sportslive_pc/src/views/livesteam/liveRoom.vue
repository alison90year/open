<template>
  <div id="zbj" style="margin-left: 4%">
    <div class="zbjroom">
      <div class="zbjroominner">
        <div class="media">
          <div class="mediatop">
            <div>
              ...
              ></el-avatar>
              <div>
                <h4 style="margin-bottom: 3px; font-size: 20px">
                ...
                <div
                  ...
                  "
                >
                  <i class="mai" style="margin-top: 3px; padding-right: 6px"
                    ><img src="../../assets/img/mai.png" alt="" srcset=""
                  /></i>
                  <span>{{ anchor.user_nicename }}</span>
                  <span style="padding-right: 20px"
                    >主播：{{ nick_name }}
                  </span>
                  <span style="padding-right: 20px">房间号：{{ showid }}</span>
                  <img
                    src="../../assets/livehot.png"
                    alt=""
                    srcset=""
                ...
                <ul>
                  <li>
                    <i>
                      ...
                      /> </i
                    ><span
                      style="font-size: 16px; font-size: 16px; color: #959db0"
                      >{{ follow_num }}</span
                    >
                  </li>
                  <li v-if="!isGuanzhu">
                  ...
                  <li v-else><span> 已关注</span></li>
                  <!-- <li><span>立即下载</span></li> -->
                </ul>
              </div>
              <div>
                <p>
                  <span @click="jubao">举报/投诉</span>

                  <el-popover placement="bottom" width="164" trigger="hover">
                    <div style="text-align: center">
                      <img
                        src="../../assets/images/longya.png"
                        alt
                    ...
                    <i slot="reference" style="font-style: normal">分享</i>
                  </el-popover>
                </p>
              </div>
            </div>
            ...
            <div style="display: flex; width: 100%">
              ...
              <div>
                <div style="display: flex">
                  ...
                  />
                  <div
                    class="time-week-main"
                    style="display: flex; width: 464px"
                  >
                    <div
                      ...
                      >
                        <div class="gift-main-popover">
                          ...
                          >
                            ...
                            />
                            <p style="width: 170px">共需要{{ allMoney }}钻石</p>
                            <el-input
                              style="width: 66px; margin: 0 10px 0 -25px"
                ...
                >
                  ...
                  />
                  <p style="line-height: 34px; margin-top: 5px">
        ...
        <div class="chat">
          ...
          <div class="contribution-info">
            <div class="contribution-2">
              <div class="contribution-bg-2">
                ...
                <img
                  :src="rankList1.live_user.avatar"
            ...
            <div class="contribution-1">
              <div class="contribution-bg-1">
                ...
                <img
                  :src="rankList2.live_user.avatar"
            ...
            <div class="contribution-3">
              <div class="contribution-bg-3">
                ...
                <img
                  :src="rankList3.live_user.avatar"
          ...
          <div class="scoller chatroom" id="xiaoxi">
            <!-- currentGift -->
            <div class="current-gift-main" v-if="giftShow">
              <div class="current-gift">
                <img :src="currentGift.user.avatar" class="current-gift-show" />
                <div class="current-gift-text">
                  <p class="current-text-1">{{ currentGift.user.nick_name }}</p>
                  <p class="current-text-2">{{ currentGift.gift.name }}</p>
                </div>
                <img
                  :src="currentGift.gift.icon"
                  class="current-gift-show-min"
                />
              </div>
              <div
                style="color: #ff7718; padding-top: 17px; padding-left: 10px"
              >
                X <span style="font-size: 28px">{{ currentGift.count }}</span>
              </div>
            </div>
            ...
            <div v-for="(item, i) in xiaoxilistShow" :key="i">
              ...
              >
                <!-- :class="
                   item.user.noble_name == '皇帝'
                     ...
                     : 'mianfei'
                 " -->
                <!-- <div :style="{backgroundImage:'url(' + item.user.level_icon + ')'}" class="img-bg">
                   <div style="line-height: 0px">{{ item.user.level }}</div>
                </div> -->
                <div>
                  <img
                    v-if="item.user.noble_icon"
                    :src="item.user.noble_icon"
                    width="20px"
                    style="margin: 4px 3px 5px 5px"
                  />
                </div>
                <span
              ...
              >
                <img
                  ...
                  width="20px"
                  height="26px"
                  style="margin: 6px 3px 5px 50px"
                />
                <div
                  :style="{
                    backgroundImage: 'url(' + item.user.level_icon + ')',
                  }"
                  style="
                    height: 40px;
                    width: 45px;
              ...
              <div
                style="
                  ...
                  display: flex;
                "
                v-if="item.type == 'set_house_manage'"
                :class="
                  item.noble_id == '1'
                    ? 'huangdi'
                    : item.noble_id == '2'
            ...
            <div class="bounced" v-if="isShowBounced">
              ...
              />
              <div class="user-info">
                {{ currentUserInfo.user.nick_name }}
                <div class="user0info-lv">
                  LV {{ currentUserInfo.user.level }}
                </div>
                <div class="bounced-btn-msg" v-if="setUserType">
                  <div v-if="setUserType == '1'">
                    <p>
                      确定设置
                      {{ currentUserInfo.user.nick_name }} 为本直播间房管？
                    </p>
                  </div>
          ...
          <div style="padding: 5px 0">
            ...
            >
              ...
              <el-popover
                placement="top-start"
                popper-class="room-img-popover-color"
                trigger="hover"
              >
                <div>
                  <ul
            ...
            >
              <el-input
                ...
                v-model="sendContent"
              ></el-input>
              <el-button type="primary" @click="sendXiaoXi(null)">
                发送
              </el-button>
            </div>
          </div>
...
export default {
      ...
      listener(msg) {
        ...
        if (msg.type == "fullscreen") {
          if (msg.detail.isFullscreen) {
            ...
            // 全屏
            let fatherdom =
              document.getElementsByClassName("vcp-controls-panel")[0];
  ...
  methods: {
    getChatmemberList() {
      ...
      chatmember(params).then((res) => {
        console.log(
          res,
          "zhib人数人数人数人数人数人数人数人数人数人数人数--------------"
        );
      });
    },
    getNewChatNew() {
    ...
    getanchorlist(type) {
      ...
      anchorlist(params).then((res) => {
        if (res.code == 0) {
          ...
          console.log(this.rankList1, "000000000000000000000000000000000");
        }
      });
    },
    ...
    onMessage(event) {
      ...
      if (data.uid) {
        if (data.type == "longya_get_into") {
          ...
          // this.sendXiaoXi()
          this.getChatmemberList();
        } else if (data.type == "set_house_manage") {
          this.isHav = false;
          this.setHonse.map((item) => {
          ...
          if (!this.isHav) {
            this.xiaoxilistShow.push(data);
            this.setHonse = this.xiaoxilistShow;
          }
        } else if (data.type == "out_user") {
          this.isHav = false;
          this.outUser.map((item) => {
            if (data.uid == item.uid) {
              this.isHav = true;
              return;
            }
          ...
          if (!this.isHav) {
            this.xiaoxilistShow.push(data);
            this.outUser = this.xiaoxilistShow;
          }
        } else if (data.type == "withdraw_msg") {
          this.isHav = false;
          this.withdraw.map((item) => {
            if (data.msg_id == item.id) {
              this.isHav = true;
              return;
            }
          });
          if (!this.isHav) {
            this.xiaoxilistShow.push(data);
            this.withdraw = this.xiaoxilistShow;
          }
        } else {
          this.isHav = false;
        ...
        if (!this.isHav) {
          ...
          this.giftImg = setInterval(() => {
            if (this.setIntervalNum == 4) {
              ...
              this.giftShow = false;
              // this.currentGift = {}
              console.log(this.currentGift, "当前礼物==========");
    ...
    guanzhu() {
      console.log("");
      const liveuid = this.$route.query.liveuid;
      const params = {
        uid: JSON.parse(window.localStorage.getItem("user")).id,
        token: window.localStorage.getItem("token"),
        live_uid: liveuid,
    ...
    userInfoBtn(item) {
      if (
        this.liveDetailInfo.live_user.noble_id ==
        JSON.parse(window.localStorage.getItem("user")).noble_id
      ) {
    ...
    serMsgBtnOk() {
      ...
      const data = {
        ...
        nick_name: this.currentUserInfo.user.nick_name,
        stream: query.stream,
        msg_id: this.currentUserInfo.id,
        source: "pc",
      };
        ...
        .mediatop {
          ...
          >div:first-child {
            ...
            p:last-child {
              ...
              // width:16px;
              // height:16px;
              // background: url('~@/assets/img/mai.png') no-repeat 0 center;
        ...
        .chatroom {
          ...
          .current-gift-main {
            ...
            .current-gift {
              ...
              background: #ffffff;
              border-radius: 90px;
              box-shadow: 0px 1px 6px 0px #ff7718;
              display: flex;
          ...
          .huangdi {
            background-image: url('../../assets/into-huangdi.png');
            // background-size: 100% 100%;
          }
          ...
          .gongjue {
            background-image: url('../../assets/into-gongjue.png');
            background-size: 100% 100%;
          }

          .houjue {
            background-image: url('../../assets/into-houjue.png');
            background-size: 100% 100%;
          }

          .zijue {
            background-image: url('../../assets/into-zijue.png');
            background-size: 100% 100%;
          }

          .qishi {
            background-image: url('../../assets/into-qishi.png');
            background-size: 100% 100%;
          }
