        ...
        <div class="LiveNoble-box">
          ...
          <div class="LiveNoble-bottom" v-if="currentNav == 'emperor'">
            <div class="bottom-left">
              <div style="display: flex;margin-top: 5px;align-items: center;">开通骑士：<span style="color: #DBB16F">368</span>龙钻/月续费皇帝：<span style="color: #DBB16F">199</span>龙钻/月<img style="margin:0 5px" src="@/assets/liveNoble/balance.png" /><span style="color: #DBB16F">龙钻余额: {{ $store.state.user.info.coin }}</span>龙由主播“{{ nick_name }}”为您开通</div>
            </div>
          ...
          <div class="LiveNoble-bottom" v-if="currentNav == 'knight'">
            ...
            <img src="@/assets/liveNoble/open.png" style="cursor: pointer;margin-left: 15px" @click="openNobleBtn('骑士')"/>
          </div>
        </div>
      </div>
    </el-dialog>
