  ...
  <div id="fixturelist">
      ...
      <div class="nav-item-box">
        <div class="nav-item-header">
          ...
          <div class="header-right">
            今日<span class="number">{{
              football.length ? football.length : 0
            }}</span
            >场比赛
          </div>
        </div>
        <div
          ...
          :style="
            open ? 'overflow: hidden;height: 106px;' : 'overflow: inherit'
          "
        >
          <div
            ...
            :key="index"
            class="gamename"
            @click="getmatch(item, index)"
          >
            {{ item.name }}
          </div>
        </div>
        <div v-if="open == true" class="unfold" @click="open = false">
          展开<i class="arrows"></i>
        </div>
        <div v-else class="put" @click="open = true">
          收起<i class="noarrows"></i>
        </div>
      </div>
      <div class="nav-item-box">
        <div class="nav-item-header">
          ...
          <div class="header-right">
            今日<span class="number">{{
              basketball.length ? basketball.length : 0
            }}</span
            >场比赛
          </div>
        </div>
        <div
          class="nav-item-content"
          :style="
            open2 ? 'overflow: hidden;height: 106px;' : 'overflow: inherit'
          "
        >
          <div
            v-for="(item, index) in basketball"
            :key="index"
            class="gamename"
            @click="getmatch(item, index)"
          >
        ...
        <div v-if="open2 == true" class="unfold" @click="open2 = false">
          展开<i class="arrows"></i>
        </div>
        <div v-else class="put" @click="open2 = true">
          收起<i class="noarrows"></i>
        </div>
      </div>
    </div>
    ...
    <div class="time_fixturelist">
      ...
      <div class="live">
        ...
        <div :class="{ active: active == 2 }" @click="active = 2" class="all">
          所有
        </div>
      </div>
    </div>
    <div v-if="active == 1" class="right_fixturelist">
      <div v-for="(item, index) in match" :key="index" class="game_nav">
        <div class="left_game">
          <div class="team_top">
            <div class="team">
              <img class="teamicon" :src="item.main_logo" />
              <div class="teams">{{ item.main_name }}</div>
            </div>
            <div class="score">{{ item.main_fraction }}</div>
          </div>
          <div class="team_down">
            <div class="team">
              <img class="teamicon" :src="item.deputy_logo" />
              <div class="teams">{{ item.deputy_name }}</div>
            </div>
        ...
        <div class="center_game">
          ...
          <div class="playto">
            ...
            <div
              v-if="item.is_make == 0 && item.is_live == 0 && item.status == 1"
              class="yuyue"
            ...
            <div
              v-if="item.is_make == 1 && item.is_live == 0 && item.status == 1"
              class="playover"
            >
              已预约
            </div>
        ...
        <div v-if="item.anchor.length" class="right_game">
          <public-swiper
            :option="item.anchor"
    ...
    <div v-else class="right_fixturelist">
      <div v-for="(item, index) in list" :key="index" class="game_nav">
        <div class="left_game">
          <div class="team_top">
            <div class="team">
              <img class="teamicon" :src="item.main_logo" />
        ...
        <div class="center_game">
          ...
          <div class="playto">
            ...
            >
            <div v-if="item.status == 8" class="playover">已结束</div>
            <a v-if="item.is_live == 1 && item.status == 2">直播中...</a>
          </div>
        </div>
        <div v-if="item.anchor.length" class="right_game">
          <public-swiper
...
.left_fixturelist {
  ...
  .left_title {
    ...
    margin-top: 16px;
    margin-left: 12px;
    background: url('../../assets/btn-saishi-xuanzhe-1@2x.13c028d83716212c0fb62bc24b0ac12c.png') no-repeat;
