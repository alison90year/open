        ...
        <el-form-item prop="user_card_front">
          ...
          <div>
            ...
            >
              ...
              <a
                class="changephoto"
                style="position: absolute; top: 100px; left: 0; width: 220px"
                >点击选择身份证正面图片</a
              >
            </el-upload>
          </div>
          <div>
            ...
            >
              <img v-if="imageUrl2" :src="imageUrl2" class="idcard" />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
              <a class="changephoto" style="position: absolute; top: 100px; left: 0; width: 220px">点击选择身份证反面图片</a>
            </el-upload>
          </div>
        </el-form-item>
