                ...
                <div class="media">
                    ...
                    <div class = 'animation_content' v-if="is_play=='animation' ">
                        <div class = "content" v-if="animation_url != '' ">                          
                            <iframe ref="iframe" id="animation_content" :src="animation_url" frameborder="0" scrolling="yes" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
                    ...
                    <div class = 'video_content' v-else>
                      <div class = "content" v-if ="video_url != '' ">

                        <iframe ref="iframe" width="1140" id="video_content" :src="video_url" frameborder="0" scrolling="yes"  allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                      </div>
