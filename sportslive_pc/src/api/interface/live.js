...
//下播
export  const  StopRoom  =  ( params )  =>  post ({  url :  ' Live.stopRoom ' ,  params })

//直播详情
export const LiveuserLiveinfo = (params) => post({ url: 'Live.userLiveinfo', params})
...
// 用户预约
export const appointment = (params) => get({ url: 'Make.appointment', params})
...
// 开播设置历史记录列表
export const changeLiveList = (params) => post({ url: 'Live.userLiveList', params})
...
// 禁言
export const liveBanUser = (params) => post({ url: 'Chat.live_ban_user', params})
